    ...
    return (
        <div id='controls-wrapper' ref={ref}>
            ...
            <Grid container direction='row' alignItems='center' justifyContent='center'>
                <IconButton onMouseUp={onRewind} id='rewindff' className='control-icons' aria-label='rewind'>
                    <FastRewindIcon fontSize='inherit' />
                </IconButton>

                <IconButton onMouseUp={onFastForward} className='control-icons' aria-label='forward'>
            ...
            <Grid
                ...
                style={{ padding: 10 }}
            >
                <IconButton onMouseUp={onPlayPause} className="control-icons" aria-label="play or pause">
                    {videoStatus === "playing" ? (
                ...
                <Grid item xs={1}>
                                    <Grid container alignItems="center" direction="column">
                                        ...
                                        <IconButton onMouseUp={onMute} id='volumeicon' className='control-icons' aria-label='volume button'>
                ...
                <Grid item>
                    ...
                    <IconButton onMouseDown={onToggleFullScreen} className='classes.bottomIcons'>
